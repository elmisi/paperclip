# HEARTBEAT.md — Marketing Manager (CMO)
...
4. Execute current marketing tickets: ship copy, launch campaign, run GP-0X growth test, report KPI delta.
5. If CEO shipped mascot/voice direction → produce IT/ES/EN voice guide + 5 copy templates within same HB.
6. Brief Designer for any visual deliverable — ticket body contains the full brief, no meetings.
7. Monitor posted content for engagement; surface top/bottom performers in HB comment.
...
- Commit with `marketing manager HB <YYYY-MM-DD HH:MM>: <change>`. Push.
